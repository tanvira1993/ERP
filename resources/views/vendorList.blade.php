<div class="table-head">
	<h3 class="head ">Manage Vendors</h3>

	<table class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
		<thead class="thead-dark">
			<tr>
				<th class="th-sm" width="10%">SN <br/><input ng-model="search.vendor_id" class="form-control input-sm" ></th>
				<th class="th-sm" width="22%">Vendor Name<br/><input ng-model="search.name" class="form-control input-sm" ></th>
		...
		<tbody>
			<tr ng-repeat="(key, value) in vendorList | filter:{vendor_id: search.vendor_id, name: search.name, address: search.address, phone_number: search.phone_number}">
